/*
===============================================================================
Stored procedure: Load Silevr Layer (Bronze -> Silver)
===============================================================================
Script Purpose: 
    This stored procedure performs the ETL (Extraction, Transformation, and Load) 
...
Parameters:
    None.
    This stored procedure does not accept any parametes or return any value.
			...
			SET @end_time = GETDATE();
				...
				INSERT INTO 
						...
						CASE WHEN cid LIKE 'NAS%' THEN SUBSTRING (cid, 4, LEN(cid)) 
							...
							ELSE bdate 
							END bdate, --Set future birthdates to Unknown
